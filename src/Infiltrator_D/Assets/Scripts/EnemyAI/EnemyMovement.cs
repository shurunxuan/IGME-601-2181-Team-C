...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void UpdateAlertness(float incr, float timer)
    {
        ...
        if (debug) 
        {
            //Debug.Log("Alertness Level = " + Alertness + "    " + (AlertnessIncrementFactor * incr) + " " + AlertnessTimer);
            //Debug.Log("Alertness Timer" + AlertnessTimer);
        }
    }
    ...
    private void WalkToSource()
    {
        ...
        ////TODO:Move 100 to max alert variable
